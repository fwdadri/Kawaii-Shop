...
const  About= () => {//funcion flecha para indicar que es una funcion
    ...
    <Header/>
     ...
     <div className='text-b'><img src={imgproducts} alt="" className='img-foto' /> </div>
      ...
      <div className='borde'>
        <p className='text-c'>
           Una cosa que probablemente no sabías acerca de Kawaii Gift Shop, es que su fundadora, Adriana, es la responsable de diseñar cada uno de los hermosos arreglos que llegan a tu casa en esas fechas especiales.
